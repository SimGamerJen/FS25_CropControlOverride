    ...
    if g_server ~= nil then
        ...
        if operation ~= "requestSettings" and operation ~= "syncSettings" and operation ~= "adminStatus" and operation ~= "operationResult" then
            local returnsOperationResult = operation == "applyRule"
                or operation == "calendarShiftPreview"
                or operation == "calendarShiftApply"
                or operation == "calendarCustomPreview"
                or operation == "calendarCustomApply"
            ...
            if returnsOperationResult and connection ~= nil then
                ...
                local changesServerState = operation == "applyRule" or operation == "calendarShiftApply" or operation == "calendarCustomApply" or operation == "resetBlocked"
